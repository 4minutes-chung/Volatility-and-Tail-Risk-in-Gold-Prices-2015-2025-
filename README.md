...
> **Already committed:** These helper files were merged into the default
> branch, so there is no extra “accept” button for you to press. If you
> see a “View PR” link on GitHub, it simply points to the pull request
> where the change originated; the files are already part of the main
> repository history as soon as you pull the latest commit.
